...
export default function AddMemoryButton({ onClick }: AddMemoryButtonProps) {
  return (
    <button
      onClick={onClick}
      className="rise press absolute right-5 z-10 flex items-center gap-2 px-5 py-3 rounded-full font-semibold text-sm"
      style={{
        background: 'rgba(255,255,255,0.92)', color: 'var(--teal-600)',
        backdropFilter: 'blur(16px) saturate(1.4)',
        WebkitBackdropFilter: 'blur(16px) saturate(1.4)',
        border: '0.5px solid rgba(16,20,22,0.1)',
        boxShadow: '0 8px 28px rgba(16,20,22,0.18)',
