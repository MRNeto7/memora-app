...
export default function AddMemoryButton({ onClick }: AddMemoryButtonProps) {
  return (
    <button
      onClick={onClick}
      className="absolute bottom-6 right-5 z-10 flex items-center gap-2 px-5 py-3 rounded-full text-white font-semibold text-sm transition-transform active:scale-95"
      style={{
        background: '#0D4F57',
