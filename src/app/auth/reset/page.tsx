...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="page-enter min-h-screen flex flex-col items-center justify-center px-5" style={{ background: '#0D4F57' }}>
      <h1 className="text-2xl font-semibold mb-6" style={{ color: '#EAE5DD' }}>Reset password</h1>

      <div className="w-full max-w-sm rounded-3xl p-6" style={{ background: '#EAE5DD' }}>
        {status === 'verifying' && (
          <p className="text-sm text-center py-6" style={{ color: '#7D878D' }}>Checking your reset link…</p>
        )}

        {status === 'invalid' && (
          <div className="text-center py-4">
            <p className="text-sm font-semibold mb-2" style={{ color: '#0D4F57' }}>This link has expired or already been used</p>
            <p className="text-xs mb-5" style={{ color: '#7D878D' }}>Request a new reset link from the sign-in screen.</p>
        ...
        {status === 'done' && (
          <div className="text-center py-6">
            ...
            <p className="text-sm font-semibold" style={{ color: '#0D4F57' }}>Password updated</p>
            <p className="text-xs mt-1" style={{ color: '#7D878D' }}>Taking you to your map…</p>
          </div>
        )}
      </div>
    </div>
